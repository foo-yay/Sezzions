...
- Hosted account ownership, workspace metadata, sign-out, and migration-entry actions should be consolidated into a dedicated Account primary section instead of being spread across the Setup shell.
