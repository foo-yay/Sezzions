...
class ResetDialog(QDialog):
    ...
    def _update_button_state(self):
        ...
        # Check if checkbox is checked AND user typed "DELETE"
        checkbox_confirmed = self.confirm_checkbox.isChecked()
        text_confirmed = self.type_confirm_input.text().strip().upper() == "DELETE"
